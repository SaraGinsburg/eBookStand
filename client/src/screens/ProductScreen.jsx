...
const ProductScreen = () => {
  ...
  useEffect(() => {
    ...
    if (reviewSent) {
      toast({
        description: 'Product review sent.',
        status: 'success',
        isClosable: true,
      });
  ...
  const hasUserReviewed = () => product.reviews.some((rev) => rev.user === userInfo._id);

  const onSubmit = () => dispatch(createProductReview(product._id, userInfo._id, comment, rating, title));
  const addItem = () => {
          ...
          <Box
            ...
            <Stack direction={{ base: 'column', lg: 'row' }} align={{ lg: 'flex-start' }}>
              <Stack
                ...
                {product.stock === 0 && (
                  <Badge rounded='full' w='76px' fontSize='0.8em' colorScheme='red'>
                    Sold out
                  </Badge>
                )}
                ...
                <Stack spacing='5'>
                  ...
                  <Flex
                    ...
                    <Button isDisabled={product.stock <= amount} onClick={() => changeAmount('plus')}>
              ...
              <>
                ...
                {reviewBoxOpen && (
                  <Stack mb='20px'>
                    ...
                    <Button w='140px' colorScheme='orange' onClick={() => onSubmit()} isDisabled={hasUserReviewed()}>
                      Publish review
                    </Button>
                  </Stack>
                )}
